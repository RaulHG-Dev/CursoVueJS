var FormKitVue = (function (exports, Vue) {
    ...
    function next(async, result) {
      ...
      if (state.input === currentRun) {
        ...
        if (result === false) {
          ...
          removeMessage2(node, validation);
        }
  ...
  function removeMessage2(node, validation) {
